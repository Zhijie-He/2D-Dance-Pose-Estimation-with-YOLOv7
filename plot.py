...
def main():
    ...
    EXTRACTED_DATA_PATH = ['I:\\GitHub_Zhijie\\2D-dance-pose-estimation-yolov7\\output\\test_video.json']
    for file_infex, json_path in enumerate(EXTRACTED_DATA_PATH):
        # create video frame folder
        frames_path = os.path.join(current_path, "frames", json_name[file_infex].split(".")[0])
